...
<acme:form>
	<acme:form-textbox
		code="authenticated.investor-record.form.label.investor"
		path="investor" />

	<acme:form-textbox
		code="administrator.investor-record.form.label.sector" path="sector" />

	<acme:form-url
		code="administrator.investor-record.form.label.investingStatement"
		path="investingStatement" />
	<acme:form-textarea
		code="administrator.investor-record.form.label.stars" path="stars" />
