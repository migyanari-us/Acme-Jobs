...
<acme:list>
	...
	<acme:list-column code="authenticated.offer.list.label.text" path="text" width="30%"/>
	
	<acme:list-column code="authenticated.offer.list.label.moneyMax" path="moneyMax" width="10%"/>
	
	<acme:list-column code="authenticated.offer.list.label.moneyMin" path="moneyMin" width="10%"/>
