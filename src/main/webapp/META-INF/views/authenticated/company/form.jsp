...
<acme:form readonly="true">
	...
	<acme:form-url code="authenticated.company.form.label.web" path="web" />
	...
	<acme:form-checkbox code="authenticated.company.form.label.incorporated" path="incorporated" />
	<acme:form-integer code="authenticated.company.form.label.stars" path="stars" />
