...
@Service
public class AdministratorCompanyDeleteService implements AbstractDeleteService<Administrator, Company> {
	...
	@Override
	public void delete(Request<Company> request, Company entity) {
		assert request!=null;
		assert entity!=null;
