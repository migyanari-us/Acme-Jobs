...
@Service
public class AdministratorInvestorRecordsUpdateService implements AbstractUpdateService<Administrator, InvestorRecord> {
	...
	@Override
	public void update(Request<InvestorRecord> request, InvestorRecord entity) {
		// TODO Auto-generated method stub
		assert request != null;
		assert entity != null;
